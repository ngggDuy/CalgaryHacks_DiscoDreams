...
messaging.getToken({vapidKey: "BA_qB5kfbiiHQgMnGa6HJTuTs0Cc3tghhwMjg6V1IDWoj4OXIFEV6Ce5O9uyDNlbF4lediZQdb7pOD6RVIloD30"}).then((currentToken) => {
    if (currentToken) {
...
messaging.onMessage(function (payLoad) {
    // catches user and sends different notification if user already on page
